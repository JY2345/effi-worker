...
var MailerController = /** @class */ (function () {
    ...
    // }
    MailerController.prototype.checkEncryptMessage = function (res, q) {
        return __awaiter(this, void 0, void 0, function () {
            var token, verificationStatus, responseMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = decodeURIComponent(q);
                        return [4 /*yield*/, this.mailerService.checkToken(token)];
                    case 1:
                        verificationStatus = _a.sent();
                        responseMessage = this.mailerService.handleResponsePage(verificationStatus);
    ...
    ], MailerController.prototype, "checkEncryptMessage");
